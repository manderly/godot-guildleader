...
var displaySkillWoodcraft = preload("res://menus/heroPage_heroStatDisplay.tscn").instance()
...
func _ready():
	...
	tabSkills.add_child(displaySkillWoodcraft)
...
func _update_stats():
	...
	displaySkillWoodcraft._update_fields("Woodcraft", global.selectedHero.skillWoodcraft)
